...
import 'package:finalproj/screens/regis_success/regis_success_screen.dart';
...
class _CompleteProfileFormState extends State<CompleteProfileForm> {
  ...
  void UpdateUserData(firstName) async {
    var currentUser = FirebaseAuth.instance.currentUser;

    if (currentUser != null) {
      currentUser.updateProfile(displayName: firstName);
      Navigator.pushNamed(context, RegisSuccessScreen.routeName);
    }
  }
